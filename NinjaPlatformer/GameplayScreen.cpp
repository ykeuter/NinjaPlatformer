...
void GameplayScreen::onEntry() {
    ...
    // Init player
    m_player.init(m_world.get(), glm::vec2(0.0f, 30.0f), glm::vec2(2.0f),
                  glm::vec2(1.0f, 1.8f), GameEngine::ColorRGBA8(255, 255, 255, 255));
...
void GameplayScreen::draw() {
    ...
    if (m_renderDebug) {
        ...
        for (auto& b : m_boxes) {
            ...
            m_debugRenderer.drawBox(destRect, GameEngine::ColorRGBA8(255, 255, 255, 255), b.getBody()->GetAngle());
        }
    ...
    Light playerLight;
    playerLight.color = GameEngine::ColorRGBA8(255, 255, 255, 128);
    playerLight.position = m_player.getPosition();
    playerLight.size = 30.0f;
    
    Light mouseLight;
    mouseLight.color = GameEngine::ColorRGBA8(255, 0, 255, 150);
